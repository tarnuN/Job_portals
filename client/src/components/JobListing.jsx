...
const JobListing = () => {
  ...
  useEffect(() => {
    ...
    const matchesTitle = job => searchFilter.title.trim() === "" || job.title.toLowerCase().includes(searchFilter.title.toLowerCase());
    const matchesSearchLocation = job => searchFilter.location.trim() === "" || job.location.toLowerCase().includes(searchFilter.location.toLowerCase());
            ...
            <>
              ...
              <div className='mb-4 text-gray-600'>
                ...
                {searchFilter.location && (
                  <span className='ml-2 inline-flex items-center gap-2.5 border border-red-200 px-4 py-1.5 rounded'>
                    {searchFilter.location}
      ...
      <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
        ...
        {/* Pagination */}
        {
          filteredJobs.length > 0 && (
            <div className='flex gap-2 items-center justify-center space-x-2 mt-6'>
              <a href="#job-list">
