        ...
        <div className='bg-white text-black rounded-lg w-full'>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border-sky-400 rounded-xl'>
            <div className='flex flex-col md:flex-row items-center'>
              ...
              <div className='text-center md:text-left text-netural-700'>
            ...
            <div className='flex flex-col justify-center text-end text-sm max-md:text-center'>
              <button className='bg-blue-600 text-white px-6 py-2 rounded sm:px-2'>
                Apply Now
              </button>
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start gap-10 px-10'>
            <div className='w-full lg:w-2/3'>
              ...
              <button className='bg-blue-600 p-2.5 px-10 text-white rounded mt-4'>Apply Now</button>
            </div>

            {/* ✅ Fixed: companyId typo */}
